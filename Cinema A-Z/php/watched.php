...
<a class="navbar-brand" href="#" ><img width = "75"  src="a2z.png"></a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
      <a class="nav-item nav-link active" href="watched.php?username=<?= $_GET['username']; ?>">Watched </a>
      </li>   
    </ul>
  </div>  
  <a href = "logout.php"  type="button" class="btn btn-danger">Logout</a>
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['username']))
                                    {
                                        ...
                                        <h2 style = "color: #40E0D0">Watched</h2>
                                        <div class="row"> 
                                        <?php
                                        $r = $_GET['username'];
                                        $query = "SELECT * from watched WHERE username= '$r'";
