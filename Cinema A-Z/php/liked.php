...
<a class="navbar-brand" href="#" ><img width = "75"  src="a2z.png"></a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
      <a  class="nav-item nav-link active" href="liked.php?username=<?= $_GET['username']; ?>" >Liked </a>
      </li>
      <li class="nav-item">
  ...
  <a href = "logout.php"  type="button" class="btn btn-danger">Logout</a>
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['username']))
                                    {
                                        ...
                                        <h2 style = "color: #40E0D0">Liked</h2>
                                        <div class="row"> 
                                        <?php
                                        /**
                                         * Getting all the movies which are liked by the user
                                         */
                                        $r = $_GET['username'];
                                        $query = "SELECT * from liked WHERE username= '$r'";
                                                ...
                                                <form method="post">
                                                    <?php
                                                         ...
                                                         */
                                                         ...
                                                         <button class="btn btn-danger butt" value= <?=$joined?> name='Remove'> Dislike</button>
