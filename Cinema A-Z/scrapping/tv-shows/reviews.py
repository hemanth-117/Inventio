...
def reviews(link):
    """| the function is used to print reviews of all tv-shows in IMDB genrated by the link.
    ...
    :param link: link of tv-shows in IMDB from which we are scrapping user reviews of each
    :type info: string
    """
    r = requests.get(link)
        ...
        for i in range(0,100):
            ...
            for j in user:
                ...
                if(cnt==3):
                    break
            file.write('\n')
reviews('https://www.imdb.com/list/ls008957859/')
reviews('https://www.imdb.com/list/ls008957859/?sort=list_order,asc&st_dt=&mode=detail&page=2')
reviews('https://www.imdb.com/list/ls008957859/?sort=list_order,asc&st_dt=&mode=detail&page=3')